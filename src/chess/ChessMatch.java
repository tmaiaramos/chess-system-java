...
private ChessPiece newPiece(String type, Color color) {
    ...
    private Piece makeMove(Position source, Position target) {
        ...
        if (p instanceof King && target.getColumn() == source.getColumn() + 2) {
            Position posSourceRook = new Position(source.getRow(), source.getColumn() + 3);             
            Position posTargetRook = new Position(source.getRow(), source.getColumn() + 1);
            ChessPiece rook = (ChessPiece) board.removePiece(posSourceRook);
            board.placePiece(rook, posTargetRook);
            rook.increaseMoveCount();
        }
        // #specialmove castling queen side
        if (p instanceof King && target.getColumn() == source.getColumn() - 2) {
            Position posSourceRook = new Position(source.getRow(), source.getColumn() - 4);
            Position posTargetRook = new Position(source.getRow(), source.getColumn() - 1);
            ChessPiece rook = (ChessPiece) board.removePiece(posSourceRook);
            board.placePiece(rook, posTargetRook);
            rook.increaseMoveCount();
    ...
    private void undoMove(Position source, Position target, Piece capturedPiece) {
        ...
        if (p instanceof King && target.getColumn() == source.getColumn() + 2) {
            Position posSourceRook = new Position(source.getRow(), source.getColumn() + 3);             
            Position posTargetRook = new Position(source.getRow(), source.getColumn() + 1);
            ChessPiece rook = (ChessPiece) board.removePiece(posTargetRook);
            board.placePiece(rook, posSourceRook);
